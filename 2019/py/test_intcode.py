...
class TestComputer(unittest.TestCase):
    ...
    def test_day2tests(self):
        ...
        cases = [("1,9,10,3,2,3,11,0,99,30,40,50", 3500),
        ("1,0,0,0,99", 2),
        ("2,3,0,3,99", 2),
        ("2,4,4,5,99,0", 2),
    ...
    def test_day5_part1(self):
        data = data19(7)
        self.assertEqual(max([self._day5_part1((data, ','.join(map(str,x)))) for x in itertools.permutations(range(5))]), 99376)
    ...
    def test_day5_part2(self):
        data = data19(7)
        self.assertEqual(max([self._day5_part2((data, ','.join(map(str,x)))) for x in itertools.permutations([5,6,7,8,9])]), 8754464)
