...
def filter_digits(s: str) -> List[str]:
    return list(x for x in s if x in string.digits)


def answer1(inp: str) -> int:
...
def filter_digits_and_words(s: str):
    return regex.findall(
        "[1234567890]|one|two|three|four|five|six|seven|eight|nine", s, overlapped=True
    )
