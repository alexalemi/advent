...
for line in info:
    ...
    if match[0] and match[1] == 'begins':
        ...
        asleep_times[current_gaurd] = asleep_times.get(current_gaurd, 0) + end - current_asleep
        asleep_minutes.setdefault(current_gaurd, np.zeros(60, dtype='int32'))[current_asleep:end] += 1
        current_asleep = None
